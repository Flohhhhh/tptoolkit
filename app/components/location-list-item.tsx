...
export default function LocationListItem(props: {
  ...
  return (
    <button
      onClick={onClick}
      className={cn(
        "pl-3 pr-2 py-1 rounded-md flex justify-between gap-2 items-center w-full hover:cursor-pointer hover:brightness-95 dark:hover:brightness-125 transition animate-in",
        selected === location
